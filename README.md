<h1 align="center">🛒 Tienda Bloom Beauty – Simulador de Inventario 📦💄🌸✨💌</h1>
<p align="center">Sistema de simulación de inventarios hecho en JAVA </p>
...
En este caso, el programa se aplicó a mi tienda virtual de maquillaje; el fin de este proyecto es optimizar el proceso de llevar un inventario actualizado y correcro del stock, ingresos y egresos de este negocio llamado "Bloom Beauty".

---

## ✨ ¿Qué es este proyecto?

Una simulación por consola de una tienda de maquillaje con gestión de productos, usuarios, compras y más. 
...
- 👩🏻‍💻 Implementación de patrón de diseño Singleton y Factory
...
1. Asegúrate de tener Java y un editor de código instalados.
